...
public class SecurityConfig {
 ...
 public SecurityConfig(UserDetailsService userDetailsService, UserRepository userRepository, JwtAuthenticationEntryPoint jwtAuthenticationEntryPoint) {
...
//
 ...
 public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
  http
          ...
          .antMatchers("/enjoyalbania/register/**").permitAll()
